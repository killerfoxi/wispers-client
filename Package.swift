...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/s-te-ch/wispers-client/releases/download/v0.8.0-rc4/CWispersConnect.xcframework.zip",
            checksum: "d9979a11438f5975ab1f3efac6cd1262d0cb507c03b19710a5ae7c368219d9e4"
        ),
        .target(
            name: "WispersConnect",
