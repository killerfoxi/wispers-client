...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/s-te-ch/wispers-client/releases/download/v0.8.1-rc5/CWispersConnect.xcframework.zip",
            checksum: "b009d6f759a350ebde726d3656012f0c33002ce76746540d0652dadaa5202dfe"
        ),
        .target(
            name: "WispersConnect",
