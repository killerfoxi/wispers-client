...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/s-te-ch/wispers-client/releases/download/v0.8.0-rc3/CWispersConnect.xcframework.zip",
            checksum: "08e587b8033882deadd80acfb92e9b920385b70938965682bfe06d28ea7cbe1d"
        ),
        .target(
            name: "WispersConnect",
