...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/s-te-ch/wispers-client/releases/download/v0.8.0/CWispersConnect.xcframework.zip",
            checksum: "c310a21e6b6e5d04fe3972a7e24ca2ad97a86171d07fe7717289947440a45df0"
        ),
        .target(
            name: "WispersConnect",
