...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/s-te-ch/wispers-client/releases/download/v0.8.1/CWispersConnect.xcframework.zip",
            checksum: "2239ee030051160760561a7b5b91139552cac041001c8b7b9caa4fbaab4ccbb0"
        ),
        .target(
            name: "WispersConnect",
